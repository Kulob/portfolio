      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            ...
            области. Я специализируюсь на создании веб-сайтов и приложений, используя HTML, CSS и
            JavaScript. Я имею опыт работы с фреймворк, такими как React и умею работать с
            библиотеками, такими как Tailwind и MUI.
          </p>
          <p>
